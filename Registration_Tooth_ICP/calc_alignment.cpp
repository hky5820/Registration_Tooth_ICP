...
void calc_mat_cross_covariance(vector<float> &vec_for_cross_cov_x1,
	...
	mat_cross_covariance(0, 1) = calc_mat_element(vec_for_cross_cov_x1, vec_for_cross_cov_x2, avg1.x, avg2.y);
	mat_cross_covariance(0, 2) = calc_mat_element(vec_for_cross_cov_x1, vec_for_cross_cov_x2, avg1.x, avg2.z);
	mat_cross_covariance(1, 0) = calc_mat_element(vec_for_cross_cov_x1, vec_for_cross_cov_x2, avg1.y, avg2.x);
	mat_cross_covariance(1, 1) = calc_mat_element(vec_for_cross_cov_x1, vec_for_cross_cov_x2, avg1.y, avg2.y);
	mat_cross_covariance(1, 2) = calc_mat_element(vec_for_cross_cov_x1, vec_for_cross_cov_x2, avg1.y, avg2.z);
	mat_cross_covariance(2, 0) = calc_mat_element(vec_for_cross_cov_x1, vec_for_cross_cov_x2, avg1.z, avg2.x);
	mat_cross_covariance(2, 1) = calc_mat_element(vec_for_cross_cov_x1, vec_for_cross_cov_x2, avg1.z, avg2.y);
	mat_cross_covariance(2, 2) = calc_mat_element(vec_for_cross_cov_x1, vec_for_cross_cov_x2, avg1.z, avg2.z);
}
...
void calc_alignment(vector<pair<XYZ, XYZ>> &pair_closest_point, Matrix4f &mat_result_of_alignment) {
	...
	avg2.x = sum2.x / (float)size; avg2.y = sum2.y / (float)size; avg2.z = sum2.z / (float)size;
	// calc_centroid
	...
	// rotation
	vector<float> vec_for_cross_cov_x1, vec_for_cross_cov_y1, vec_for_cross_cov_z1, 
